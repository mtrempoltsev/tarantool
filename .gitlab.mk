...
docker_perf_bootstrap:
	...
	${DOCKERFILE_BUILD} --build-arg image_from=${IMAGE_PERF} \
		-t ${IMAGE_PERF_BUILT} -f images/Dockerfile.ubuntu_perf_build .
...
perf_nosqlbench:
	/opt/runners/nosqlbench-benchmarking/run.sh ${TYPE}
